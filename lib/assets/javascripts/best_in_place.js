...
BestInPlaceEditor.prototype = {
    ...
    update: function () {
        ...
        if (
            ...
            !confirm(this.warning_before_save)
              ...
              console.log("confirm if", this.warning_if_old_value)
              console.log("old value", this.oldValue.toLowerCase().includes(this.warning_if_old_value));
              this.abort();
              return true;
          }
    ...
    initOptions: function () {
        ...
        self.warning_if_old_value = self.element.data("bipWarningIfOldValue") || self.warning_if_old_value;
